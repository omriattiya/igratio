  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
      <div className={summaryStatCardClass}>
        <p className="text-xs font-medium uppercase tracking-wide text-slate-500 dark:text-blue-200/65">
          {copy.following}
        </p>
      ...
      <div className={summaryStatCardClass}>
        ...
        <p className="mt-1 text-xs text-slate-500 dark:text-blue-200/55">{copy.netDifferenceHint}</p>
      </div>
      <div className={summaryStatCardClass}>
        <p className="text-xs font-medium uppercase tracking-wide text-slate-500 dark:text-blue-200/65">
          {copy.followersRatio}
        ...
        <p className="mt-1 text-xs text-slate-500 dark:text-blue-200/55">{copy.followersRatioHint}</p>
      </div>
    </div>
  );
}
